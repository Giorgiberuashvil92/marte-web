...
const HeroSection = () => {
  return (
    <div className="relative bg-[#F6F8FE] overflow-hidden">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-6xl lg:text-[96px] font-black leading-[100px] text-[#1F2E47] uppercase items-start flex flex-col">
                ...
                <span className="block text-center">APP</span>
              </h1>

              <p className="text-xl text-[#8B98AF] font-medium leading-[28px] max-w-lg uppercase">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-900 px-8 py-4 rounded-2xl font-semibold text-lg border-2 border-gray-300 hover:border-gray-400 transition-all duration-300 shadow-lg hover:shadow-xl">
                <FaGooglePlay />
      ...
      <div className="absolute top-10 -right-50 w-1/2 h-full">
